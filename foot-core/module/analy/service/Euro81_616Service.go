...
func (this *Euro81_616Service) buildData(v *entity2.MatchLast, a18betData *entity3.AsiaLast, e81data *entity3.EuroLast, e616data *entity3.EuroLast, result int) *entity5.AnalyResult {
	//比赛结果
