...
import (
	...
	"opensource.io/go_spider/core/common/mlog"
	"opensource.io/go_spider/core/common/page"
	"opensource.io/go_spider/core/common/request"
	"opensource.io/go_spider/core/common/util"
...
// The FootDownloader download page by package net/http.
...
type FootDownloader struct {
}

func NewFootDownloader() *FootDownloader {
	return &FootDownloader{}
}

func (this *FootDownloader) Download(req *request.Request) *page.Page {
	var mtype string
...
func (this *FootDownloader) getCharset(header http.Header) string {
...
func (this *FootDownloader) changeCharsetEncoding(charset string, sor io.ReadCloser) string {
    ischange := true
...
func (this *FootDownloader) changeCharsetGoIconv(charset string, sor io.ReadCloser) string {
    var err error
...
func (this *FootDownloader) changeCharsetEncodingAuto(contentTypeStr string, sor io.ReadCloser) string {
	var err error
...
func (this *FootDownloader) changeCharsetEncodingAutoGzipSupport(contentTypeStr string, sor io.ReadCloser) string {
	var err error
...
func (this *FootDownloader) downloadFile(p *page.Page, req *request.Request) (*page.Page, string) {
	var err error
	var urlstr string
...
func (this *FootDownloader) downloadHtml(p *page.Page, req *request.Request) *page.Page {
	var err error
...
func (this *FootDownloader) downloadJson(p *page.Page, req *request.Request) *page.Page {
	var err error
	p, destbody := this.downloadFile(p, req)
	if !p.IsSucc() {
		return p
...
func (this *FootDownloader) downloadText(p *page.Page, req *request.Request) *page.Page {
	p, destbody := this.downloadFile(p, req)
	if !p.IsSucc() {
		return p
	}
